...
{\small
\CVItem{\href{https://github.com/karabulut18/redis}{Redis from Scratch} \hfill \textit{C++}}
{
\begin{itemize}
\item Developed a high-performance Key-Value store from the ground up, implementing custom protocol parsing and socket programming.
\end{itemize}
}
}
\end{minipage}
